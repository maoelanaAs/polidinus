        ...
        <div class="col-lg-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="src/admin/obat/add.php" method="post" class="row g-3">
                <div class="col-12">
                          ...
                          <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form action="src/admin/obat/edit.php" method="post">
                        ...
                        <div class="modal fade" id="deleteModal<?php echo $data['id'] ?>" tabindex="-1">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form action="src/admin/obat/delete.php" method="post">
                                  <input type="hidden" class="form-control" id="id" name="id"
