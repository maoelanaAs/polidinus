        ...
        <div class="col-lg-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="src/admin/pasien/add.php" method="post" class="row g-3">
                <div class="col-12">
                          ...
                          <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="updateModalLabel">Ubah Data Pasien</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                  aria-label="Close"></button>
                              </div>
                              <div class="modal-body">
                                <form action="src/admin/pasien/edit.php" method="post">
                                  ...
                                  <div class="col-12 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="editNoKTP"
                                      value="<?php echo $data['no_ktp'] ?>" name="no_ktp" />
                                  </div>
                                  <div class="col-12 mb-3">
                                  ...
                                  <div class="col-12 mb-3">
                                    <label for="editNoRM" class="form-label">No. Rekam Medis</label>
                                    <input type="text" class="form-control" id="editNoRM"
                                      value="<?php echo $data['no_rm'] ?>" name="no_rm" disabled />
                                  </div>
                                  <div class="col-12 mb-3">
                        ...
                        <div class="modal fade" id="deleteModal<?php echo $data['id'] ?>" tabindex="-1">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form action="src/admin/pasien/delete.php" method="post">
                                  <input type="hidden" class="form-control" id="id" name="id"
